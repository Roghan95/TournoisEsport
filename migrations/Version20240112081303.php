 ...
 */
final class Version20240112081303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tournoi (id INT AUTO_INCREMENT NOT NULL, jeu_id INT NOT NULL, organisateur_id INT NOT NULL, nom_tournoi VARCHAR(100) NOT NULL, nom_organisation VARCHAR(100) NOT NULL, logo_tournoi VARCHAR(255) DEFAULT NULL, date_debut DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', date_fin DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', description LONGTEXT NOT NULL, banniere_tr VARCHAR(255) NOT NULL, lien_twitch VARCHAR(255) DEFAULT NULL, reglement LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', region VARCHAR(50) NOT NULL, nb_joueurs_max INT NOT NULL, nb_joueurs INT DEFAULT NULL, INDEX IDX_18AFD9DF8C9E392E (jeu_id), INDEX IDX_18AFD9DFD936B2FA (organisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
