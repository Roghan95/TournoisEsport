 ...
 */
final class Version20231103202905 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equipe (id INT AUTO_INCREMENT NOT NULL, proprietaire_id INT NOT NULL, nom_equipe VARCHAR(255) NOT NULL, logo VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_2449BA1576C50E4A (proprietaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE participant (id INT AUTO_INCREMENT NOT NULL, game_match_id INT NOT NULL, utilisateur_id INT NOT NULL, is_win TINYINT(1) DEFAULT 0 NOT NULL, INDEX IDX_D79F6B1181FA53F0 (game_match_id), INDEX IDX_D79F6B11FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tournoi (id INT AUTO_INCREMENT NOT NULL, jeu_id INT NOT NULL, organisateur_id INT NOT NULL, nom_tournoi VARCHAR(100) NOT NULL, nom_organisation VARCHAR(100) NOT NULL, date_debut DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', date_fin DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', nb_joueur_max INT NOT NULL, description LONGTEXT NOT NULL, banniere_tr VARCHAR(255) NOT NULL, lien_twitch VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_18AFD9DF8C9E392E (jeu_id), INDEX IDX_18AFD9DFD936B2FA (organisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
